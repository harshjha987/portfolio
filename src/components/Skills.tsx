  ...
  
  {
    svg: (
      <svg
        ...
        viewBox='0 0 128 128'
      >
        <path fill='#ffffff' d='M63.984 17.184 127.964 128H0Zm0 0' />
      </svg>
    ),
    name: "Vercel",
  },
  ...
  },
  {
    svg: (
      ...
      >
        <path
          fill="#5382a1"
          d="M47.617 99.003s-4.761 2.773 3.396 3.707c9.879 1.13 14.947.968 25.845-1.084 0 0 2.869 1.798 6.872 3.353-24.451 10.497-55.308-.605-36.113-5.976zM44.168 85.453s-5.336 3.961 2.812 4.812c10.547 1.09 18.873 1.18 33.354-1.602 0 0 1.998 2.02 5.137 3.125-29.548 8.641-62.446.68-41.303-6.335z"
        />
        <path
          fill="#e76f00"
          d="M67.088 61.241c6.025 6.932-1.578 13.166-1.578 13.166s15.3-7.943 8.275-17.869c-6.565-9.003-11.607-13.465 15.658-28.865 0 0-42.809 10.697-22.355 33.568z"
        />
        <path
          fill="#5382a1"
          d="M91.436 108.291s3.531 2.912-3.89 5.162c-14.102 4.272-58.705 5.563-71.123.17-4.446-1.93 3.913-4.609 6.547-5.178 2.752-.597 4.324-.488 4.324-.488-4.975-3.5-32.101 6.86-13.809 9.83 50.102 8.105 91.353-3.644 77.951-9.496zM50.502 67.313s-22.748 5.406-8.052 7.381c6.209.831 18.593.641 30.161-.326 9.462-.797 18.969-2.498 18.969-2.498s-3.338 1.43-5.756 3.077c-23.261 6.118-68.183 3.268-55.271-2.991 10.931-5.274 19.949-4.643 19.949-4.643z"
        />
      </svg>
    ),
    name: "Java",
  ...
  
  {
    svg: (
      ...
      >
        <path
          fill="#00758f"
          d="M449.8 314.7c-13.2-5.5-34.1-8.8-44.9-16.5-9.6-6.7-17.7-23.5-26.4-42.4-9.4-20.5-19.9-43.5-37.4-63.3-21.1-23.8-46.3-37.7-74.7-41.3-15.5-1.9-32.4-.6-47.6 4.3-18.4 5.9-38.4 15.8-51.4 34.1-3.4 4.7-6.6 10.1-9.5 15.7-15.1-1.4-29.4 4.7-38.2 14.7-7.2 8.1-11.3 18.4-11.4 29.6-.1 11.6 4.3 22.9 12.2 31.2 14.4 14.9 34.4 21.5 53.2 25.4-3.7 9.1-5.7 19.2-4.5 28.9 1.6 14.1 8.6 26.7 19.4 35.2 15.3 11.8 35.6 15.4 56.2 11.1 17.6-3.5 33.5-12.5 46.7-23.8 9.4 8.5 22.2 15.3 36.5 18.2 16.7 3.3 33.7 1.6 48.7-5.5 14.4-6.7 28.5-19.6 36.6-35.8 3.2-6.5 1.4-14.3-5.2-17.1z"
        />
      </svg>
    ),
    name: "MySQL",
